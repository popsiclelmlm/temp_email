...
import { DEFAULT_SEO, resolveSeoText } from '../utils/seo'
...
const seoTitle = computed(() => resolveSeoText(openSettings.value.title, t('seoTitle') || DEFAULT_SEO.title))
const seoDescription = computed(() => resolveSeoText(openSettings.value.description, t('metaDescription') || DEFAULT_SEO.description))
