...
<template>
    <div>
        <section class="seo-intro">
            <h1>{{ t('heroTitle') }}</h1>
            <p class="seo-description">{{ t('heroDescription') }}</p>
            <ul class="seo-benefits" :aria-label="t('benefitsLabel')">
                <li v-for="benefit in seoBenefits" :key="benefit">{{ benefit }}</li>
            </ul>
        </section>
