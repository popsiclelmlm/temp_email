...
import { resolveGoogleAdConfig } from './utils/google-ads'

const {
  isDark, loading, useSideMargin, telegramApp, isTelegram
} = useGlobalState()
const googleAdConfig = resolveGoogleAdConfig()
...
const showManualAds = computed(() => !isMobile.value && googleAdConfig.enableManualAdUnits);
const gridMaxCols = computed(() => showManualAds.value ? 8 : 12);
        ...
        <n-message-provider container-style="margin-top: 20px;">
          <n-grid x-gap="12" :cols="gridMaxCols">
            <n-gi v-if="showSideMargin" span="1">
              <div class="side" v-if="showManualAds">
