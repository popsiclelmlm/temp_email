export const jaMessages = {
  ...
  "views.common.Login.heroTitle": "プライベートな使い捨て受信箱として使える一時メール",
  "views.common.Login.heroDescription": "登録、認証コード、試用アカウント用の使い捨て受信箱を作成します。個人の受信箱を公開したくないときに使えます。",
  "views.common.Login.benefitsLabel": "一時メールのメリット",
  "views.common.Login.benefitRealInbox": "本当の受信箱を非公開に保つ",
  "views.common.Login.benefitSpam": "登録や試用からの迷惑メールを減らす",
  "views.common.Login.benefitVerification": "認証コードや確認メールをすばやく受信",
  "views.common.Login.benefitNoAccount": "一度きりの利用にアカウント不要",
