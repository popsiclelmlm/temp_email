export const esMessages = {
  ...
  "views.common.Login.heroTitle": "Correo temporal para buzones privados de un solo uso",
  "views.common.Login.heroDescription": "Crea un buzón desechable para registros, códigos de verificación y cuentas de prueba. Úsalo cuando necesites un email sin exponer tu bandeja personal.",
  "views.common.Login.benefitsLabel": "Ventajas del correo temporal",
  "views.common.Login.benefitRealInbox": "Mantén privada tu bandeja real",
  "views.common.Login.benefitSpam": "Reduce el spam de registros y pruebas",
  "views.common.Login.benefitVerification": "Recibe rápido códigos y confirmaciones",
  "views.common.Login.benefitNoAccount": "No requiere cuenta para uso puntual",
