export const ptBRMessages = {
  ...
  "views.common.Login.heroTitle": "E-mail temporário para caixas privadas de uso único",
  "views.common.Login.heroDescription": "Crie uma caixa descartável para cadastros, códigos de verificação e contas de teste. Use quando precisar de um e-mail sem expor sua caixa pessoal.",
  "views.common.Login.benefitsLabel": "Vantagens do e-mail temporário",
  "views.common.Login.benefitRealInbox": "Mantenha sua caixa real privada",
  "views.common.Login.benefitSpam": "Reduza spam de cadastros e testes",
  "views.common.Login.benefitVerification": "Receba códigos e confirmações rapidamente",
  "views.common.Login.benefitNoAccount": "Não exige conta para uso pontual",
