export const deMessages = {
  ...
  "views.common.Login.heroTitle": "Temporäre E-Mail für private Einmal-Postfächer",
  "views.common.Login.heroDescription": "Erstelle ein Wegwerf-Postfach für Registrierungen, Bestätigungscodes und Testkonten. Nutze es, wenn du eine E-Mail-Adresse brauchst, aber dein persönliches Postfach nicht offenlegen möchtest.",
  "views.common.Login.benefitsLabel": "Vorteile temporärer E-Mail",
  "views.common.Login.benefitRealInbox": "Halte dein echtes Postfach privat",
  "views.common.Login.benefitSpam": "Reduziere Spam aus Registrierungen und Tests",
  "views.common.Login.benefitVerification": "Empfange Codes und Bestätigungen schnell",
  "views.common.Login.benefitNoAccount": "Kein Konto für einmalige Nutzung nötig",
