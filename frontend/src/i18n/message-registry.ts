export const MESSAGE_REGISTRY = {
  ...
  "views.Header": {
    ...
    "metaDescription": {
      "en": "Create a temporary email and disposable email address to receive codes, hide your real inbox, reduce spam, and protect privacy without registration.",
      "zh": "快速创建临时邮箱接收验证码和注册邮件，隐藏真实邮箱，减少垃圾邮件和隐私泄露，无需注册，用完即走。"
    },
    "ok": {
      "en": "OK",
      "zh": "确定"
    ...
    "seoTitle": {
      "en": "Temp Email - Temporary Email & Disposable Email for Privacy",
      "zh": "临时邮箱 - 隐私安全的一次性邮箱"
    },
    "status": {
      "en": "Status",
  ...
  "views.common.Login": {
    ...
    "benefitNoAccount": {
      "en": "No account required for one-time use",
      "zh": "一次性使用无需注册账号"
    },
    "benefitRealInbox": {
      "en": "Keep your real inbox private",
      "zh": "隐藏真实邮箱，降低暴露风险"
    },
    "benefitSpam": {
      "en": "Reduce spam from sign-ups and trials",
      "zh": "减少注册和试用带来的垃圾邮件"
    },
    "benefitVerification": {
      "en": "Receive verification and confirmation emails quickly",
      "zh": "快速接收验证码和确认邮件"
    },
    "benefitsLabel": {
      "en": "Temporary email benefits",
      "zh": "临时邮箱优势"
    },
    ...
    "heroDescription": {
      "en": "Create a disposable mailbox for sign-ups, verification codes, and trial accounts. Use it when you need an email address but do not want to expose your personal inbox.",
      "zh": "为注册、验证码和试用账号快速创建一个一次性邮箱。在需要邮箱地址但不想暴露个人邮箱时使用，用完即走。"
    },
    "heroTitle": {
      "en": "Temporary email for private, one-time inboxes",
      "zh": "安全隐私的一次性临时邮箱"
    },
    "login": {
      "en": "Login",
